...
function MembersList({ handleRedirectToTaskDetail }) {

  let memberData = [
    {
      "location": "Lagos",
      "email": "member@email.com",
      "telephone": "08025465635",
      "sales": "2343"
    }
  ];
    ...
    <>
        ...
        <tbody>
            ...
            <TableRowDiv bg="#fff">
                ...
                <td className="tdstyle">
                    <small style={{ fontSize: '15px', color: '#929AA7' }}>Lagos</small>
                </td>
                <td className="tdstyle">
                    <small style={{ fontSize: '15px', color: '#929AA7' }}>member@gmail.com</small>
                </td>
                <td className="tdstyle">
                    <small style={{ fontSize: '15px', color: '#929AA7' }}>080234538789</small>
                </td>
                <td className="tdstyle">
                    <small style={{ fontSize: '15px', color: '#929AA7' }}>₦28,000</small>
                </td>
                <td className="tdstyle">

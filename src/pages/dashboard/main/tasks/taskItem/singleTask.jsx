...
function SingleTaskItem({
  ...
  return (
    <Div
      ...
      <Div display="flex" height={heightInner} gap="10px">
        <Div>
          <Img
            w={imgWidth ? imgWidth : "70px"}
            height={imgHeight ? imgHeight : "70px"}
            br="3px"
            src={image}
            alt={image}
          />
        ...
        <Div
          ...
          <Div display="flex" flexDirection="column">
            ...
            <Div
              ...
              <SpottrP fs="12px">
                {!!data
                  ? `${data?.currencySymbol} ${data?.rewardFeeAmount}${data?.unit}`
                  : "N4,800,000"}
              </SpottrP>
            </Div>
          </Div>
      ...
      <Div display="flex" justify="space-between">
        ...
        <Div>
          <SpottrP fs="15px" fw="bold" color={Colors.danger}>
            {!!data ? data.days + " days left" : "02:33min left"}
          </SpottrP>
        </Div>
      </Div>
    </Div>
